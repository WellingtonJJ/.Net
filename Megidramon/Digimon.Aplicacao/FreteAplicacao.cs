            ...
            while (reader.Read())
            {
                var temObjeto = new Frete()
                {
                    ...
                    Tipo = reader["TIPO"].ToString(),
                      ...
                      RLogradouro  = reader["@RLogradouro"].ToString(),
                      RNumero  = reader["@RNumero"].ToString(),
                      RComplemento  = reader["@RComplemento"].ToString(),
                      RCep  = reader["@RCep"].ToString(),
                      RBairro  = reader["@RBairro"].ToString(),
                      RCidade  = reader["@RCidade"].ToString(),
                      RUf = reader["@Ruf"].ToString()
                };
